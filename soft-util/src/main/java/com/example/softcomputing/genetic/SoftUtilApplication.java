...
public class SoftUtilApplication {
    ...
    public static void main(String[] args) {
        ...
        switch (choice) {
            ...
            case 3:
                ...
                break;
            default:
                logger.warn("Invalid choice. Please run again and select 1, 2, or 3.");
        }
    ...
    private static void runBinaryExample() {
        logger.info("--- Binary Chromosome GA ---");
        ...
        logger.info(String.format("Config: popSize=%d, geneLength=%d, mutationRate=%.3f, maxGen=%d", 
        ...
        ga.run();
        logger.info("Binary GA completed.\n");
    }

    private static void runIntegerExample() {
        logger.info("--- Integer Chromosome GA ---");
        ...
        logger.info(String.format("Config: popSize=%d, geneLength=%d, geneRange=[%d,%d], mutationRate=%.3f, maxGen=%d", 
        ...
        ga.run();
        logger.info("Integer GA completed.\n");
    }

    private static void runFloatingPointExample() {
        logger.info("--- FloatingPoint Chromosome GA ---");
        ...
        logger.info(String.format("Config: popSize=%d, geneLength=%d, bounds=[%.1f,%.1f], mutationRate=%.3f, maxGen=%d", 
        ...
        ga.run();
        logger.info("FloatingPoint GA completed.\n");
    }
}
