...
public class TestCases {
    ...
    public static void runInteger_SinglePCrsv_IntMut_FlReplacement() {
        ...
        List<IntegerChromosome> intPop = PopulationInitializer.randomIntegerPopulation(populationSize, geneLength, geneMin, geneMax);
    ...
    public static void runBin_UniformCrsv_BinMut_SSReplacement() {
        ...
        _logger.info(String.format("Config: popSize=%d, geneLength=%d, maxGen=%d",populationSize, geneLength, maxGenerations));

        ChromosomeFactory<Integer, BinaryChromosome> binFactory = new BinaryChromosomeFactory();
        List<BinaryChromosome> binPop = PopulationInitializer.randomBinaryPopulation(populationSize, geneLength);
    ...
    public static void runIntegrationFloatingPermutation() {
        ...
        List<FloatingPointChromosome> population = PopulationInitializer.randomFloatingPopulation(populationSize, geneLength, lowerBound, upperBound);
        ChromosomeFactory<Double, FloatingPointChromosome> factory = new FloatingPointChromosomeFactory(lowerBound,upperBound);
