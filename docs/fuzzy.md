...
This module provides the building blocks for constructing **Fuzzy Logic Controllers (FLC)**.

---

##  Overview

Fuzzy Logic allows systems to reason in a way similar to human decision-making using linguistic rules.
